...
public class DunningIntervals extends RecurlyObjects<DunningInterval> {
    ...
    @Override
    public void setRecurlyObject(final DunningInterval value) {
        super.setRecurlyObject(value);
    }

    @JsonIgnore
    @Override
    public DunningIntervals getStart() {
        return getStart(DunningIntervals.class);
    }

    @JsonIgnore
    @Override
    public DunningIntervals getNext() {
        return getNext(DunningIntervals.class);
    }
}
