...
public class PercentageTiers extends RecurlyObjects<PercentageTier> {
  ...
  @Override
  public void setRecurlyObject(final PercentageTier value) {
    super.setRecurlyObject(value);
  }

  @JsonIgnore
  @Override
  public PercentageTiers getStart() {
    return getStart(PercentageTiers.class);
  }

  @JsonIgnore
  @Override
  public PercentageTiers getNext() {
    return getNext(PercentageTiers.class);
  }
}
