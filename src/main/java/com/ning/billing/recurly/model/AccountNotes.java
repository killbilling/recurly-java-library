...
public class AccountNotes extends RecurlyObjects<AccountNote> {
    ...
    @Override
    public void setRecurlyObject(final AccountNote value) {
        super.setRecurlyObject(value);
    }

    @JsonIgnore
    @Override
    public AccountNotes getStart() {
        return getStart(AccountNotes.class);
    }

    @JsonIgnore
    @Override
    public AccountNotes getNext() {
        return getNext(AccountNotes.class);
    }
}
