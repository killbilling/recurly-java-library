...
public class DunningCycles extends RecurlyObjects<DunningCycle> {
    ...
    @Override
    public void setRecurlyObject(final DunningCycle value) {
        super.setRecurlyObject(value);
    }

    @JsonIgnore
    @Override
    public DunningCycles getStart() {
        return getStart(DunningCycles.class);
    }

    @JsonIgnore
    @Override
    public DunningCycles getNext() {
        return getNext(DunningCycles.class);
    }
}
