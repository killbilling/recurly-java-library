...
public class AbstractTransaction extends RecurlyObject {
    ...
    public boolean equals(Object o) {
        ...
        if (refundable != null ? !refundable.equals(that.refundable) : that.refundable != null) return false;
        if (status != null ? !status.equals(that.status) : that.status != null) return false;
        if (test != null ? !test.equals(that.test) : that.test != null) return false;
        if (voidable != null ? !voidable.equals(that.voidable) : that.voidable != null) return false;
