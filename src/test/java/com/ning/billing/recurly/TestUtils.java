...
public class TestUtils {
    ...
    public static AddOn createRandomAddOnPercentageTiered(final int seed) {
        ...
        addonPercentageTier.setUsagePercentage("10.0");
        ...
        addonPercentageTier2.setUsagePercentage("20.0");
        addonPercentageTiers.add(addonPercentageTier2);
  
        currencyPercentageTier.setAddonPercentageTiers(addonPercentageTiers);
        currencyPercentageTiers.add(currencyPercentageTier);
  
        addOn.setCurrencyPercentageTiers(currencyPercentageTiers);
    ...
    public static SubscriptionAddOn createRandomSubscriptionAddOnPercentageTiered() {
        ...
        percentageTier1.setUsagePercentage("20.0");
  
        percentageTier2.setEndingAmountInCents(null);
        percentageTier2.setUsagePercentage("40.0");
