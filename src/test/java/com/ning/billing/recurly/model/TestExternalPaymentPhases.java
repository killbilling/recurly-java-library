 ...
 */
 ...
 public class TestExternalPaymentPhases extends TestModelBase {
     ...
     public void testDeserialization() throws Exception {
         final String externalPaymentPhasesData = 
         ...
         final ExternalPaymentPhases externalPaymentPhases = xmlMapper.readValue(externalPaymentPhasesData, ExternalPaymentPhases.class);
         Assert.assertEquals(externalPaymentPhases.size(), 1);
 
         final ExternalPaymentPhase externalPaymentPhase = externalPaymentPhases.get(0);
