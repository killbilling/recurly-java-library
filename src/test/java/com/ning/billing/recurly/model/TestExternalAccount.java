...
public class TestExternalAccount extends TestModelBase {
  ...
  public void testDeserialization() throws Exception {
    final String externalAccountData = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
    ...
    final ExternalAccount externalAccount = xmlMapper.readValue(externalAccountData, ExternalAccount.class);
