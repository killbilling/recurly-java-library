 ...
 */
 ...
 public class TestExternalProductReferences extends TestModelBase {
 
     @Test(groups = "fast")
     public void testDeserialization() throws Exception {
         final String externalProductReferencesData = 
         ...
         final ExternalProductReferences externalProductReferences = xmlMapper.readValue(externalProductReferencesData, ExternalProductReferences.class);
