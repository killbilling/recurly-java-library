...
//        Assert.assertEquals(invoice.getHref(), "https://api.recurly.com/v2/invoices/e3f0a9e084a2468480d00ee61b090d4d");
        ...
        Adjustment adjustment = invoice.getLineItems().get(0);
