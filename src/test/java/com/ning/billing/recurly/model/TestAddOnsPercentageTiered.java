...
public class TestAddOnsPercentageTiered extends TestModelBase {
    ...
    private void verifyAddOns(final AddOns addOns) {
        ...
        Assert.assertEquals(addOn.getCurrencyPercentageTiers().get(0).getCurrency(), "USD");
        Assert.assertEquals((int) addOn.getCurrencyPercentageTiers().get(0).getAddonPercentageTiers().get(0).getEndingAmountInCents(), 100);
        Assert.assertEquals(addOn.getCurrencyPercentageTiers().get(0).getAddonPercentageTiers().get(0).getUsagePercentage(), "10.0");
        Assert.assertEquals(addOn.getCurrencyPercentageTiers().get(0).getAddonPercentageTiers().get(1).getEndingAmountInCents(), null);
        Assert.assertEquals(addOn.getCurrencyPercentageTiers().get(0).getAddonPercentageTiers().get(1).getUsagePercentage(), "20.0");
    }
}
